...
df = pd.read_csv('E:\pyWork\pyProjects\sippython\data\denco.csv')
...
df.region.value_counts().plot(kind='hist')
...
#check for margin value, their individual margin and total sales margin like revenued
